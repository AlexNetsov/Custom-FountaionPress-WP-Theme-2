...
<div class="main-wrap full-width">
	...
	<main class="main-content">
		...
		<div class="grid-x medium-up-3 articles-container">
			...
			<?php 
				// Fullfill the rest of the grid with term posts
					...
					$current_taxonomy = get_taxonomy('category');
		...
		<div class="query-vars" term-posts-to-display="<?php echo $term_posts_to_display ?>" taxonomy="category" style="display: none"></div>
