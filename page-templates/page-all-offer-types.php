...
<div class="top-archieve-container" >
	...
	<h1><?php _e( 'Get amazing products and services !', 'ttv' )?>
	</h1>
...
<div class="main-wrap full-width">
	...
	<main class="main-content">
		...
		<div class="grid-x medium-up-3 articles-container">
			...
			<?php 
				// Fullfill the rest of the grid with term posts
					...
					$current_taxonomy = get_taxonomy('offer-type');
		...
		<div class="query-vars" term-posts-to-display="<?php echo $term_posts_to_display ?>" taxonomy="offer-type" style="display: none"></div>
