<?php
/**
Template Name: All Blog Categories
 */
...
<div class="top-archieve-container" >
	...
	<h1><?php _e( 'Read our blog posts', 'ttv' )?>
	</h1>
	<span class="archieve-subtitle"><?php _e( 'Learn our tips and tricks about renting.', 'ttv' )?>
		<br>
...
<div class="main-wrap full-width">
	...
	<main class="main-content">
		...
		<div class="grid-x medium-up-3 articles-container">
			...
			<?php 
				// Fullfill the rest of the grid with term posts
					...
					$current_taxonomy = get_taxonomy('blog-category');
		...
		<div class="query-vars" term-posts-to-display="<?php echo $term_posts_to_display ?>" taxonomy="blog-category" style="display: none"></div>
