...
<div class="top-archieve-container" >
	<div class="ttv-breadcrumbs">
		...
		<span class="breadcrumbs-current-page"><?php _e( 'Tools & Resources', 'ttv' )?></span>
	</div>
	<h1><?php _e( 'Use our free tools and resources ! Deal with ', 'ttv' )?>
		<span style="color:#017dc3;"><?php echo $current_term->name ?></span>
		<?php _e( ' faster !', 'ttv' )?>
	</h1>
	<span class="archieve-subtitle"><?php _e( 'We know that ', 'ttv' )?>
		<span style="color:#017dc3;"><?php echo $current_term->name?></span>
		<?php _e( ' are a hassle to deal with.', 'ttv' )?>
		<br>
		<?php _e( 'We developed these tools and resources to help you out.', 'ttv' )?>
	</span>
