...
<div class="top-archieve-container" >
	<div class="ttv-breadcrumbs">
		...
		<span class="breadcrumbs-current-page"><?php _e( 'Your home blog', 'ttv' )?></span>
	</div>
	<h1><?php _e( 'Read our blog posts on ', 'ttv' )?>
		<span style="color:#017dc3;"><?php echo $current_term->name ?></span>
	</h1>
	<span class="archieve-subtitle"><?php _e( 'Learn our tips and tricks about renting and ', 'ttv' )?>
		<span style="color:#017dc3;"><?php echo $current_term->name?></span>.
		<br>
		<?php _e( 'Publishing fresh content and keeping you informed every month !', 'ttv' )?>
	</span>
