...
<div class="top-archieve-container" >
	<div class="ttv-breadcrumbs">
		...
		<span class="breadcrumbs-current-page"><?php _e( 'Deals', 'ttv' )?></span>
	</div>
	<h1><?php _e( 'Get amazing ', 'ttv' )?>
		<span style="color:#017dc3;"><?php echo $current_term->name ?></span>
		<?php _e( ' products and services !', 'ttv' )?>
	</h1>
	<span class="archieve-subtitle"><?php _e( "Users of The Tenants' Voice get to enjoy special deals and discounts.", 'ttv' )?>
		<br>
		<?php _e( 'We work hard to negotiate the terms with our commercial partners, so you get the best possible offer.', 'ttv' )?>
	</span>
	...
	<main class="main-content">
		<div class="filters-row">
			...
			<div class="current-topics">
				<a class="selected-term" term-id="<?php echo $current_term->term_id ?>">
					<?php echo $current_term->name.' ('.$current_term->count.')'?>
		...
		<div class="ttv-gradient-button view-all-container">
			<a class="vc_btn3 view-all-button" href="#" title=""><?php _e( 'View more', 'ttv' )?></a>
		</div>
		<div class="query-vars" term-posts-to-display="<?php echo $term_posts_to_display ?>" taxonomy="<?php echo $current_term->taxonomy?>" style="display: none"><?php echo  json_encode($current_term->term_id) ?></div>
